            ...
            <div className="container-fluid">
                <ul className="buttons-select ms-md-auto gap-2">
                    <li className="nav-element">
                        <button className="btn btn-outline-light nav-button" type="button" onClick={() => props.setRenderComponentFunction(0)}>
                    ...
                    <li className="nav-element">
                        <button className="btn btn-outline-light nav-button" type="button" onClick={() => props.setRenderComponentFunction(1)}>
                    ...
                    <li className="nav-element">
                        <button className="btn btn-outline-light nav-button" type="button" onClick={() => props.setRenderComponentFunction(3)}>
                    ...
                    <li className="nav-element">
                        <button className="btn btn-outline-light nav-button" type="button" onClick={() => props.setRenderComponentFunction(2)}>
