...
export default function HistoryElement(props: HistoryElementProps) {
    ...
    return (
        ...
        <span className='history-element'>
            ...
            <p className='symbol'>
                <input type="checkbox" className="btn-check " id="time" autoComplete="off" checked={false} onClick={() => setRenderEdit(true)} readOnly />
            ...
            <p className='symbol'>
                <input type="checkbox" className="btn-check " id="time" autoComplete="off" checked={false} onClick={() => props.removeById(props.video.videoId)} readOnly />
                <label className="btn btn-outline-secondary button-label" htmlFor="time" >
