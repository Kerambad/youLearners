        ...
        <>
            <div className='row m-1 px-0 py-1 border border-dark'>
                ...
                <div className='col-2 py-0 px-1'>
                    <svg onClick={() => props.removeById(props.video.videoId)} xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" className="bi bi-trash3 border border-dark border-2 rounded p-2" viewBox="0 0 16 16">
