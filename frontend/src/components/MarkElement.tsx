    ...
    return (
        <>
            <span className='mark-element'>
                ...
                <p className='symbol'>
                    <input type="checkbox" className="btn-check " id="time" autoComplete="off" checked={false} onClick={() => setIsEditActive(true)} readOnly />
                    <label className="btn btn-outline-secondary button-label" htmlFor="time" >
                        <svg onClick={() => setIsEditActive(true)} xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" className="bi bi-pencil" viewBox="0 0 16 16" >
                ...
                <p className='symbol'>
                    <input type="checkbox" className="btn-check " id="time" autoComplete="off" checked={false} onClick={() => setIsEditActive(true)} readOnly />
                    <label className="btn btn-outline-secondary button-label" htmlFor="time" >
                    <svg onClick={() => handleDeleteMark()} xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" className="bi bi-trash3" viewBox="0 0 16 16" >
