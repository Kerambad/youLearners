...
class BookmarkControllerTest {
    ...
    void getAllBookmarks_ShouldReturnAllBookmarks() throws Exception {
        //GIVEN
        List<Bookmark> testValues = List.of(new Bookmark("1", "2", 5), new Bookmark("2", "3", 10));
    ...
    @Test
    @DirtiesContext
    void addNewBookmark_ShouldReturnStatusCode404BadRequest_IfAddedBookmarkHasInvalidTime() throws Exception {
        //GIVEN
        String DtoJson = """
                {
                "name": "2",
    ...
    @Test
    @DirtiesContext
    void addNewBookmark_ShouldReturnStatusCode404BadRequest_IfNameIsEmpty() throws Exception {
        //GIVEN
        String DtoJson = """
                {
                "name": "",
    ...
    void updateBookmark_ShouldReturnUpdatedBookmark() throws Exception {
        //GIVEN
        testRepo.save(new Bookmark("1","2",5));
        String DtoJson = """
                {
                "name": "2",
                "time": 5
    ...
    @Test
    @DirtiesContext
    void updateBookmark_ShouldReturnStatusCode404BadRequest_IfNameIsEmpty() throws Exception {
        //GIVEN
        String DtoJson = """
                {
                "name": "",
    ...
    @Test
    @DirtiesContext
    void updateBookmark_ShouldReturnStatusCode404BadRequest_IfAddedBookmarkHasInvalidTime() throws Exception {
        //GIVEN
        String DtoJson = """
                {
                "name": "2",
    ...
    @Test
    @DirtiesContext
    void updateBookmark_ShouldReturnStatusCode404BadRequest_IfIdDoesNotExist() throws Exception {
        //GIVEN
        String DtoJson = """
                {
                "name": "2",
    ...
    void removeBookmark_ShouldReturn_StatusCode404NotFound_IfVideoIdWasNotFound() throws Exception {
        //GIVEN
        testRepo.save(new Bookmark("2", "2", 5));
        //WHEN
        mockMvc.perform(MockMvcRequestBuilders.delete( "/api/bookmarks/1"))
                .andExpect(status().isNotFound())
                .andExpect(content().string("Bookmark Id Not Found: 1"));
